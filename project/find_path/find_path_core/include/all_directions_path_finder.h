...
namespace bmpf {
    /**
     * @brief Планировщик со смещениями во все стороны.
     *
     * Суть планирования
     ...
     *
     */
    class AllDirectionsPathFinder : public NodeGridPathFinder {
    public:
        /**
         * конструктор
         * @param scene сцена
         ...
         */
        explicit AllDirectionsPathFinder(const std::shared_ptr<bmpf::Scene> &scene,
                                         bool showTrace,
