...
#include "../../find_path/smart_path_finding/include/multirobot_path_finder.h"
...
protected:
    ...
    void init() override {
        ...
        pathFinder = std::make_shared<bmpf::OneDirectionOrderedPathFinder>(sceneWrapper, false, 1000, 15, 6000);
