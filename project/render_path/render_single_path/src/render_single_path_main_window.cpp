...
RenderSinglePathMainWindow::RenderSinglePathMainWindow(){
...
void RenderSinglePathMainWindow::onAddNew(){
    if (!centralWidget()) {
        ...
        setCentralWidget(new RenderSinglePathWindow(this, fileName.toStdString()));
    }
    else
