 ...
 */
class RenderSinglePathWidget : public bmpf::QTGLWidget {
Q_OBJECT
...
public:
     ...
     */
    explicit RenderSinglePathWidget(QSlider *slider, QWidget *parent = nullptr);
     ...
     */
    void
    setPathFinder(const std::shared_ptr<bmpf::PathFinder> &pr, std::vector<std::vector<double>> path);
...
private:
     ...
     */
    RenderSinglePathDrawer _drawer;
    /**
