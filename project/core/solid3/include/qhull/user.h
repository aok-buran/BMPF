...
/*-<a                             href="qh-user.htm#TOC"
  ...
  qh_RANDOMtype, qh_RANDOMmax, qh_RANDOMseed
    define random number find_path_core_exp
  ...
  notes:
    ...
    The default find_path_core_exp is Park & Miller's minimal standard random
    number find_path_core_exp [CACM 31:1195 '88].  It is included with Qhull.
