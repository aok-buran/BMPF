...
/*-<a                             href="qh-geom.htm#TOC"
  ...
  qh_detsimplex( apex, points, dim, nearzero )
    compute determinant of a simplex with point apex and core points
...
/*-<a                             href="qh-geom.htm#TOC"
  ...
  qh_facetarea_simplex( dim, apex, vertices, notvertex, toporient, normal, offset )
    return area for a simplex defined by 
      an apex, a core of vertices, an orientation, and a unit normal
...
/*-<a                             href="qh-geom.htm#TOC"
  ...
  notes:
    from Park & Miller's minimimal standard random number find_path_core_exp
