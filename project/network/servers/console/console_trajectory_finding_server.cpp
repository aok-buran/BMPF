...
double intervalTimeDuration = 0.1;
...
int main(int argc, char const *argv[]) {
    ...
    // создаём сервер
    std::shared_ptr<BaseServer> server = std::make_shared<TrajectoryFindingServer>(
            sceneWrapper,intervalTimeDuration, SHOW_TRACE,
            MAX_OPEN_SET_SIZE, GRID_SIZE, MAX_NODE_CNT, CHECK_CNT, THREAD_CNT
    );
